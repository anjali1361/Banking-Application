...
class TransactionDBHelper(context: Context?) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL("create table $TABLE_NAME (ID INTEGER PRIMARY KEY AUTOINCREMENT,from_name VARCHAR,to_name VARCHAR,amount INTEGER,status INTEGER)")
    }
    ...
    fun insertTransferData(fromName: String?, toName: String?, amount: Int?, status: Int): Boolean {
